...
namespace Rop.CopyPartialGenerator
{
    ...
    public class CopyPartialGenerator : ISourceGenerator
    {
        ...
        private class PartialClassesToCopyReceiver : ISyntaxReceiver
        {
            ...
            public void OnVisitSyntaxNode(SyntaxNode syntaxNode)
            {
                ...
                {
                    var atts = cds.GetDecoratedWithAny("CopyPartialTo", "CopyPartialAsImmutableRecord", "CopyPartialAsEditableClass");
